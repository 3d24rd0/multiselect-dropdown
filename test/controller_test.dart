  ...
  group('MultiSelectController', () {
    ...
    test('addItem adds item to the list', () {
      controller
        ...
        ..addItem(const DropdownItem(label: 'Item 4', value: 4));
    ...
    test('addItems adds multiple items', () {
      controller
        ...
        ..addItems([
          const DropdownItem(label: 'Item 3', value: 3),
          const DropdownItem(label: 'Item 4', value: 4),
        ]);
      expect(controller.items.length, 4);
    });
    ...
    test('clearAll only touches selected items', () {
      controller
        ..setItems([
          const DropdownItem(label: 'A', value: 1, selected: true),
          const DropdownItem(label: 'B', value: 2),
          const DropdownItem(label: 'C', value: 3, selected: true),
        ])
        ..clearAll();
      expect(controller.selectedItems.length, 0);
    ...
    test('selectAtIndex skips disabled items', () {
      controller
        ..setItems([
          const DropdownItem(label: 'A', value: 1, disabled: true),
          const DropdownItem(label: 'B', value: 2),
        ])
        ..selectAtIndex(0);
      expect(controller.selectedItems.length, 0);
    ...
    test('addItem inserts at specific index', () {
      controller
        ..setItems(createItems(3))
        ..addItem(
          const DropdownItem(label: 'Inserted', value: 99),
          index: 1,
        );
