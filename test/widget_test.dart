...
void main() {
  group('MultiDropdown Widget', () {
    ...
    testWidgets('disabled chips use theme disabled color', (tester) async {
      final items = [
        const DropdownItem(label: 'Test Chip', value: 1, selected: true),
      ];
    ...
    testWidgets('clear icon does not appear when disabled', (tester) async {
      final items = [
        const DropdownItem(label: 'Item', value: 1, selected: true),
      ];
    ...
    testWidgets('tapping clear icon deselects all items', (tester) async {
      final controller = MultiSelectController<int>();
      final items = [
        const DropdownItem(label: 'Item 1', value: 1, selected: true),
        const DropdownItem(label: 'Item 2', value: 2, selected: true),
      ];
    ...
    testWidgets('tapping chip delete removes it from selection',
      ...
      final controller = MultiSelectController<int>();
      final items = [
        const DropdownItem(label: 'To Remove', value: 1, selected: true),
        const DropdownItem(label: 'To Keep', value: 2, selected: true),
      ];
    ...
    testWidgets('renders pre-selected items as chips on load', (tester) async {
      final items = [
        const DropdownItem(label: 'Pre 1', value: 1, selected: true),
        const DropdownItem(label: 'Pre 2', value: 2, selected: true),
        const DropdownItem(label: 'Not Selected', value: 3),
      ];
    ...
    testWidgets('disabled items cannot be selected', (tester) async {
      final controller = MultiSelectController<int>();
      final items = [
        const DropdownItem(label: 'Enabled', value: 1),
        const DropdownItem(label: 'Disabled', value: 2, disabled: true),
      ];
